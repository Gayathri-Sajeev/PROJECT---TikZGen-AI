...
*IBM Bob - front end development and JS integration
...
3. Environment Setup (.env)
   Enter the required credentials in the local .env file inside the project root workspace directory to securely bind your platform    credentials:WATSONX_APIKEY="your_ibm_cloud_iam_api_key"WATSONX_PROJECT_ID="your_watsonx_studio_project_guid"WATSONX_URL="https://ibm.com"
...
Open your browser framework and paste the following link -

 🚀 Deployment link - https://tikzgenai.onrender.com/ 
